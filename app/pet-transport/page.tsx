...
export default function PetTransportPage() {
    const whatsappLink = `https://wa.me/966569487569?text=${encodeURIComponent('Hello Bahrain Transport Group! I would like to book a Pet-Friendly ride. What are your rates?')}`;
