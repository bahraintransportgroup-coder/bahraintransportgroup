...
const navItems = [
  ...
  { href: '/admin/fleet', label: 'Fleet', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 17h8M8 17l-2-5h12l-2 5M8 17H6a2 2 0 01-2-2v-1a2 2 0 012-2h.5M16 17h2a2 2 0 002-2v-1a2 2 0 00-2-2h-.5M9 10V7a3 3 0 016 0v3" />
    </svg>
  )},
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex">
        ...
        <div className="p-6 border-b border-gray-800">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-amber-500 flex items-center justify-center">
              <span className="text-black font-bold text-sm">BTG</span>
            </div>
            <div>
              <p className="text-white font-semibold text-sm">Admin Panel</p>
              <p className="text-gray-500 text-xs">Bahrain Transport</p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top bar */}
        <header className="bg-gray-900 border-b border-gray-800 px-4 lg:px-8 py-4 flex items-center gap-4">
          <button
