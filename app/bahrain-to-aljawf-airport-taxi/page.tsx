...
export const metadata: Metadata = generateSEO({
    title: 'Bahrain to Al-Jawf Airport Taxi | Long-Distance Charter',
    description: 'Long-distance private charter from Bahrain to Al-Jawf Domestic Airport (AJF) in Sakaka, approximately 1,450km. Custom quote, advance booking, or flight + local pickup.',
    keywords: 'bahrain to al-jawf airport taxi, al jawf domestic airport transfer, sakaka airport taxi from bahrain, bahrain to al jawf taxi price',
    canonicalUrl: 'https://bahraintransportgroup.com/bahrain-to-aljawf-airport-taxi',
});

export default function CompactRoutePage() {
    const whatsappLink = "https://wa.me/966569487569?text=I%20want%20a%20quote%20for%20a%20long-distance%20transfer%20from%20Bahrain%20to%20Al-Jawf%20Airport%20(AJF).";
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <header className="mb-12 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">
                        Bahrain to <span className="text-amber-600">Al-Jawf Airport</span> Charter
                    </h1>
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        A long-distance private charter to Al-Jawf Domestic Airport (AJF) in Sakaka, approximately 1,450km from Bahrain.
                    </p>
                </header>
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mb-12 flex gap-4 items-start max-w-2xl mx-auto">
                    ...
                    <p className="text-sm text-amber-900">
                        <strong>Honest note:</strong> Al-Jawf is roughly a 15-hour drive from Bahrain. We strongly recommend flying and letting us handle the <strong>local pickup at AJF</strong>. The road charter is reserved for groups or specific overland requests.
                    </p>
                </div>
                    ...
                    <div className="flex flex-col justify-center">
                        <div className="bg-slate-900 text-white p-8 rounded-3xl">
                            ...
                            <p className="text-slate-400 mb-8 text-sm leading-relaxed">
                                Tell us your dates: we'll quote the full road charter, or arrange a fixed-rate <strong>local pickup from AJF</strong> if you're flying in — the recommended option for this distance.
                            </p>
                ...
                <section className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                            <h4 className="font-bold text-slate-900 mb-2">Is driving to Al-Jawf actually recommended?</h4>
                            <p className="text-sm text-slate-600">For most travelers, no — at ~1,450km, flying is far more practical. We offer the road option mainly for groups or specific overland needs.</p>
                        </div>
                        <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                            <h4 className="font-bold text-slate-900 mb-2">Do you offer pickup if I fly into Al-Jawf?</h4>
                            <p className="text-sm text-slate-600">Yes, we can arrange a fixed-rate local chauffeur waiting for you at AJF in Sakaka.</p>
                        </div>
                    </div>
                </section>
