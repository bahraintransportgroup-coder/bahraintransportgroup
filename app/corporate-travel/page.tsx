...
export default function CorporateTravelPage() {
    const whatsappLink = `https://wa.me/966569487569?text=${encodeURIComponent('Hello Bahrain Transport Group! I would like to discuss corporate transportation services for my company.')}`;
