...
export default function StudentTransportPage() {
    const whatsappLink = `https://wa.me/966569487569?text=${encodeURIComponent('Hello Bahrain Transport Group! I am interested in your Student Transport services. Can I get a quote?')}`;
